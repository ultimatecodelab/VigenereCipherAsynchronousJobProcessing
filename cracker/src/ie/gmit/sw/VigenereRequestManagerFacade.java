...
public class VigenereRequestManagerFacade {
	...
	public VigenereRequestManagerFacade(String requestNumber){
		this.requestNumber = requestNumber;
	}
	
	//This constructor will be invoked if new request is made
	public VigenereRequestManagerFacade(int maxKeyLength , String cipherText){
